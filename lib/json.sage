...
proc _print_node(item, fmt, depth, indent):
    ...
    if t == cJSON_Array:
        ...
        if fmt:
            let nl = chr(10)
            var pad = _make_pad(indent, depth + 1)
