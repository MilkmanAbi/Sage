...
# --- barrier ---
var b = create_barrier(3)
var r1 = barrier_wait(b)  # 1st — not released
var r2 = barrier_wait(b)  # 2nd — not released
var r3 = barrier_wait(b)  # 3rd — released, resets
