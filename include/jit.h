...
// ============================================================================
// EXPERIMENTAL: JIT Compiler for Sage
//
// Status: Experimental — Night-Traders-Dev original, being evaluated.
// Enable with: make CFLAGS+=-DSAGE_EXPERIMENTAL_JIT
// Run with:    sage --jit <file.sage>
//
// Future plan: Replace with LuaJIT-based tracing JIT, heavily customised
// for Sage's type system and GC. This x86-64 method JIT is a placeholder.
// ============================================================================
...
typedef enum {
    ...
    JIT_TYPE_STRUCT   = 11,  // struct instance — value semantics (copy on assign)
} JitTypeTag;
